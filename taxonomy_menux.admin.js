...
Drupal.menu_update_parent_list = function () {
  ...
  $.ajax({
    ...
    success: function (options) {
      ...
      var selected = $('fieldset#edit-menu #edit-menu-parent-term :selected').val();
      // Remove all exisiting options from dropdown.
      $('fieldset#edit-menu #edit-menu-parent-term').children().remove();
      // Add new options to dropdown.
      jQuery.each(options, function(index, value) {
        $('fieldset#edit-menu #edit-menu-parent-term').append(
